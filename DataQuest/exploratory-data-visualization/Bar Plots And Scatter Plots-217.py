...
select = ["FILM","RT_user_norm","Metacritic_user_nom","IMDB_norm","Fandango_Ratingvalue","Fandango_Stars"]
norm_reviews = reviews[select]
norm_reviews.head(1)
...
print(norm_reviews[num_cols].iloc[0].values)
